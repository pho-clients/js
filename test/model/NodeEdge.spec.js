...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new phonetworks.NodeEdge();
  });
  ...
  describe('NodeEdge', function() {
    it('should create an instance of NodeEdge', function() {
      // uncomment below and update the code to test NodeEdge
      //var instane = new phonetworks.NodeEdge();
      //expect(instance).to.be.a(phonetworks.NodeEdge);
    });
